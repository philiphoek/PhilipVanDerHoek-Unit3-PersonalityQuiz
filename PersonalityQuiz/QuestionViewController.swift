...
class QuestionViewController: UIViewController {
    ...
    var questions: [Question] = [
        ...
        Question(text: "How much do you Sleep",
                 type: .single,
                 answers: [
                    Answer(text: "4 Hours", type: .turtle),
                    Answer(text: "6 Hours", type: .cat),
                    Answer(text: "8 Hours", type: .rabbit),
                    Answer(text: "10 Hours", type: .dog)
            ]),
        Question(text: "Who do you like in your family?",
                 type:.multiple,
                 answers: [
                    Answer(text: "Mother", type: .dog),
                    Answer(text: "Father", type: .cat),
                    Answer(text: "Sister", type: .rabbit),
                    Answer(text: "Brother", type: .turtle)
            ]),
    ...
    @IBAction func rangedAnswerButtonPressed() {
        // Checks in wat range the slider is
        let currentAnswers = questions[questionIndex].answers
    ...
    func updateUI() {
        // Updates the view according to the question index
